...
*/
let menu = []
menu.push(createMenuItem("pizza", 10, "dinner"), createMenuItem("pasta", 12, "lunch"), createMenuItem("cake", 7, "dessert"))
console.log(menu)
...
export const burger = {
  ...
  discount: function(discountType) {
    if (discountType.toLowerCase() === "teacher" || discountType.toLowerCase() === "student") {
...
*/
reviews.push({name: "Ficticious Frank", rating: 500, feedback:"Wobble wobble dubby bubby doo"})
console.log(reviews)
...
function getLastReview(array) {
  ...
  let rating = array[array.length - 1].rating
  let feedback = array[array.length - 1].feedback
  return `${name} gave the restaurant a ${rating} star review, and their feedback was: ${feedback}`
} 
